...
def get_data_loaders(
    batch_size: int = 32, valid_size: float = 0.2, num_workers: int = -1, limit: int = -1, magnitude: int = 7
):
    """
    ...
    data_transforms = {
        "train": transforms.Compose([
            ...
            transforms.RandAugment(5, magnitude=magnitude),
            transforms.ToTensor(),
    ...
    train_data = datasets.ImageFolder(
        base_path / "train",
        # add the appropriate transform defined in the data_transforms dictionary
